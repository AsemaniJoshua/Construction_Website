  ...
  return (
    <>
      ...
      <motion.section
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true, amount: 0.2 }}
        className="bg-gray-100 p-[50px] flex flex-col gap-[20px] justify-center items-center"
      >
        <img
          src={Excavator}
      ...
      <motion.section
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true, amount: 0.2 }}
        className="bg-[#1A1A1A] py-[70px] px-[50px] flex flex-col gap-[40px] justify-center items-center"
      >
